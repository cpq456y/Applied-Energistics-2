...
public class PartOreDicStorageBus extends PartStorageBus {
    ...
    public void readFromNBT(NBTTagCompound data) {
        ...
        List<MatchRule> rulesList = OreDictFilterMatcher.parseExpression(oreExp);
    ...
    private IPartitionList<IAEItemStack> getPriorityList() {
        if (priorityList == null) {
            List<MatchRule> ruleList = OreDictFilterMatcher.parseExpression(oreExp);
    ...
    public void saveOreMatch(String oreMatch) {
        if (!this.oreExp.equals(oreMatch)) {
            ...
            List<MatchRule> ruleList = OreDictFilterMatcher.parseExpression(oreMatch);
